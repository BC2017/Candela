...
See [docs/ROADMAP.md](docs/ROADMAP.md) for the phased build plan. Next: finish Phase 5 (temporal accumulation/denoising), then Phase 6 (TAA, GPU-driven culling, demo polish).
